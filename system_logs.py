...
class system_logs(object):
    ...
    def print_start_logs():
        ...
        print('code run start time ',system_logs.__instance.start_time)
        system_logs.__instance.mydevice.device_name()
        print('memory use list in print start ',system_logs.__instance.memory_usage)

    @staticmethod
    def record_memory_usage(t):
        mem_use = psutil.virtual_memory()[2]
        print('mem use list ', system_logs.__instance.memory_usage)
    ...
    def print_end_logs():
        ...
        print('end date/time every checkpoint:', dt_string)
        # run_duration = ...
